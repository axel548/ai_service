...
VALUES ('Shrek', 90, 'ANIMADA', 4, '2024-06-01', 'D');
    -- ON CONFLICT (titulo) DO NOTHING;

INSERT INTO platzi_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
VALUES ('Inception', 148, 'CIENCIA_FICCION', 5, '2010-07-16', 'D');
    -- ON CONFLICT (titulo) DO NOTHING;
...
INSERT INTO platzi_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
VALUES ('John Wick', 101, 'ACCION', 6, '2014-10-24', 'D');
    -- ON CONFLICT (titulo) DO NOTHING;
...
INSERT INTO platzi_play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
VALUES ('Joker', 122, 'DRAMA', 4, '2019-10-04', 'D');
    -- ON CONFLICT (titulo) DO NOTHING;
